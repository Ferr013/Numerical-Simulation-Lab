...
void Averages(int iblk) //Print results for current block
{
   ...
   double r, gdir;
   ofstream Gofr, Gave, Epot, Pres, Inst;
   const int wd=12;
...
//Instantaneous values for equilib. Comment after doing it the first time w/ n_step 1 and n_block 3000
    //Inst << setw(wd) << iblk <<  setw(wd) << stima_pot << setw(wd) << stima_pres << endl;
